		...
		<el-dialog title="添加或修改" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="tenant" label-width="80px" :rules="formRules" ref="tenant">
				...
				<el-form-item label="类型名称" prop="type.name">
					<el-input v-model="tenant.type.name" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="管理员" prop="admin.realName">
					<el-input v-model="tenant.admin.realName" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="地址" prop="address">
					<el-input v-model="tenant.address" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="状态" prop="state">
					<el-input v-model="tenant.state" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="入驻日期" prop="registerTime">
	...
	export default {
		...
		methods: {
			...
			getTenants(){
				...
				//分页查询
				this.$http.post("/sysmanage/tenant/list",para) //$.Post(.....)
						.then(result=>{
							console.log(result);
